...
export const verificationDescription: INodeProperties[] = [
		{
			...
			"options": [
				...
				{
					"name": "Initiate Matching Or Challenge Deposite Verification",
					"value": "Initiate Matching Or Challenge Deposite Verification",
					"action": "Initiaite Matching Service and Challenge Deposit",
				...
				},
				{
					...
					"value": "Verify Challenge Deposit",
					"action": "Verify Challenge Deposit",
		...
		},
		{
			...
			"displayOptions": {
				"show": {
					...
					"operation": [
						"Initiate Matching Or Challenge Deposite Verification"
					]
				}
			}
		},
