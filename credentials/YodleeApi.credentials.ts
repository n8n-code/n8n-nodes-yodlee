...
export class YodleeApi implements ICredentialType {
	name = 'N8nDevYodleeApi';

	displayName = 'yodlee API';

	icon: Icon = { light: 'file:../nodes/Yodlee/yodlee.svg', dark: 'file:../nodes/Yodlee/yodlee.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: '/',
			description: 'The base URL of your yodlee API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
